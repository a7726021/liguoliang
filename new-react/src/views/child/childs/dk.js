  ...
  constructor(props) {
    ...
    this.state = {
      ...
      columns: [
        ...
        { title: '贷款金额(万元)', dataIndex: 'money', key: '4', width: 180, fixed: 'left',},
        {
          title: '操作',
          key: 'operation',
          fixed: 'left',
  ...
  render() {
    return (
      <>
        ...
        <div>
          <Table pagination={{pageSize:5}} columns={this.state.columns} dataSource={this.state.data} scroll={{ x: 1300 }} />
        </div>
      </>
    )
  }
